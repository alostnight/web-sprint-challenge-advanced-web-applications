...
1. Explain what a token is used for.
   It's security feature that authenticates user that try to login to the server.
2. What steps can you take in your web apps to keep your data secure?
   Create a authentication system to protect login.
   Put protected information on a private route that will only be shown when authenticated.
3. Describe how web servers work.
   They hold information that an application request to get or edit or remover.
